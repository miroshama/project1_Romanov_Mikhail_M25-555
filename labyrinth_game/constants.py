...
ROOMS = {
    ...
    "garden": {
        "description": "Заброшенный сад с высохшим фонтаном. В центре растет странное светящееся растение.",
    ...
    "secret_chamber": {
        "description": "Тайная комната со старинными фресками на стенах. В углу стоит сундук с сокровищами.",
        "exits": {"west": "garden"},
        "items": ["ancient_amulet", "gemstone"],
        "puzzle": (
            'На стене надпись: "Что можно сломать, даже не прикасаясь к нему?" (ответ одно слово)',
            "обещание",
        ),
    },
}
