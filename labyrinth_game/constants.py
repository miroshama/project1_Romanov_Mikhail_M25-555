...
ROOMS = {
    ...
    'garden': {
          ...
          'puzzle': ('На фонтане надпись: "Я иду, но никогда не прихожу. Что я?" (ответ одно слово)', 'завтра')
    },
    'secret_chamber': {
          ...
          'puzzle': ('На стене надпись: "Что можно сломать, даже не прикасаясь к нему?" (ответ одно слово)', 'обещание')
    }
}
